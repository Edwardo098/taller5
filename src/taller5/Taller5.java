...
public class Taller5 {
    ...
    public static void main(String[] args) {
        ...
        double precio=Double.parseDouble(JOptionPane.showInputDialog("Precio inicial exámen"));
        ...
        if (eps.equals("H")){
            ...
            vlrPagar=caja.valorPagar(nivel, precio); }
                  ...
                  double salario = Double.parseDouble(JOptionPane.showInputDialog("Salario básico cotizante"));
